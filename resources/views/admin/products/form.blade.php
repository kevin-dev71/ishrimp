            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form
                            ...
                            method="POST"
                            action="{{ ! $product->id ? route('admin.products.store') : route('admin.products.update', ['product_id' => $product->id])}}"
                    >
                        @if($product->id)
                            {!! method_field('PUT') !!}
                        @endif
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nombre del Producto: <span class="required">*</span>
                            </label>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="peso">Contenido del Producto: <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input
                                        type="text"
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <a href="{{ route('admin.products.index') }}" class="btn btn-primary" type="button">Regresar</a>
