            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form
                            ...
                            method="POST"
                            action="{{ ! $cosecha->id ? route('cosechas.store') : route('cosechas.update', ['cosecha_id' => $cosecha->id])}}"
                    >
                        @if($cosecha->id)
                            {!! method_field('PUT') !!}
                        @endif
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Fecha de Cosecha: <span class="required">*</span>
                            </label>
